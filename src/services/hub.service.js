...
class HubService {
  ...
  async _processDockerTemplate(jsonPath, maintainerInfo, repoPath) {
    ...
    return {
      ...
      maintainer: maintainerInfo.maintainer || null,
      maintainer_donate: maintainerInfo.donation || null,
      donate: template.donate || null,
      type: 'docker',
      category,
      description: template.description || null,
      website: template.project || null,
      icon: template.icon || null,
      repository: template.repo || null,
      created_at,
      updated_at,
      stack_images: [],
      files: {
